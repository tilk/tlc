...
Proof. introv N. destruct* (@last_case l). Qed.
...
Proof. introv N E. subst. auto. Qed.
...
Proof. introv M. induction M; rew_map; auto. Qed.
...
Proof.  (* todo: factorise with map_app and above *)
  intros. unfold Filter.
  assert (forall accu,
